...
public class Trip implements Parcelable {
	 ...
	 */
	public Trip(String name, String start, String destination, String traveltime, ArrayList <Person> friends) {
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		// TODO - fill in here
        // will be called automatically, i have to implement
        // like
        ...
        //android.content.intent look at that for the general homework
